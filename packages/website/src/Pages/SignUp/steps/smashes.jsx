    ...
    return (
      <Fragment>
        ...
        <Typography variant="body1" gutterBottom>
          In order to provision your account we must generate a signature for your "randomness". To do this we ask you to smash 100 times, and make sure to lift your hands between each smash. It should only take a couple of minutes.
        </Typography>
